...
client.on("ready", async () => {
    ...
    client.user.setActivity("Marte Dep", { type: "WATCHING" });
   ...
   //if (command === `${prefix}hallo`) {
    ...
    if (command === `${prefix}info`) {
        ...
        var botEmbed = new discord.MessageEmbed()
            .setTitle("Info")
            .setDescription("Ik ben een bot voor de Marte Dep community")
            .setColor("#ffff00")
            .addField("Bot naam", client.user.username)
            .setThumbnail("https://cdn.discordapp.com/attachments/698086725636980806/795361794939158538/logo_marte.png")
